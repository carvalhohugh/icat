          ...
          <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex gap-3">
                ...
                <div>
                  <span className="block text-xs font-semibold text-gray-500 uppercase">Palestrantes / Convidados</span>
                  <span className="text-gray-900 font-medium">{evento.speakers}</span>
                </div>
              </li>
            </ul>
          </div>
