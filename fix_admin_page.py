...
# Replace handleSavePesquisa
handle_save_old = """  const handleSavePesquisa = () => {
...
handle_save_new = """  const handleSavePesquisa = () => {
...
content = content.replace(edit_mode_old, edit_mode_new)

# handle_save_pesquisa might have setIsModalOpen(true) in the old one in my file content
content = content.replace("setIsModalOpen(true);", "setIsModalOpen(false);", 1) # if left over
...
# Results topOpcao and totalVotos
...
# In results, replace the options rendering with questions rendering
